...
export function reducer(state, action) {
  switch (action.type) {
    ...
    case "SET_VISIBLE_IDS":
      ...
      var ids = state.selection.ids; // Start with a blank selection

      var s2 = new Selection([], null, "none", state.visibleIds); // Add each of the old selected ids to this new selection
